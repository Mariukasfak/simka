...
export async function GET(request: Request) {
  try {
    ...
    // Optimization: Using a Map instead of Array.find() reduces complexity from O(n^2) to O(n)
    // Map inherently maintains insertion order, so chronological order from query is preserved
