...
export async function GET(request: Request) {
  try {
    ...
    // Performance optimization: Replaced O(N^2) Array.reduce with O(N) Map-based lookup
    // Expected impact: ~3x faster execution for 5000+ records, reducing CPU load on the backend.
