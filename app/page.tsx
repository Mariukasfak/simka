    ...
    () => [
      {
        ...
        price: 39.99,
        description:
          "Kokybiškas, šiltas džemperis su gobtuvu. Puikiai tinka vėsesniam orui. Sudėtis: 80% medvilnė, 20% poliesteris. Gramatūra: 280 g/m².",
      },
      {
        id: "hoodie-light",
        ...
        price: 39.99,
        description:
          "Stilingas šviesus džemperis su gobtuvu. Minkštas vidus užtikrina komfortą. Sudėtis: 80% medvilnė, 20% poliesteris. Gramatūra: 280 g/m².",
      },
      {
        id: "tshirt-dark",
        ...
        price: 24.99,
        description:
          "Klasikiniai juodi marškinėliai trumpomis rankovėmis. Pagaminti iš aukštos kokybės medvilnės. Sudėtis: 100% medvilnė. Gramatūra: 180 g/m².",
      },
      {
        id: "tshirt-light",
        ...
        price: 24.99,
        description:
          "Lengvi ir patogūs balti marškinėliai. Puikiai tinka spaudai. Sudėtis: 100% medvilnė. Gramatūra: 180 g/m².",
      },
    ],
    [],
  );
    ...
    async (formData: any) => {
      ...
      try {
        ...
        const orderData = {
          ...
          printAreas: Object.keys(PRINT_AREAS).filter(
            (area) => designPreviews[area] !== null,
          ),
        };
        ...
        toast.error(
          error instanceof Error
            ? error.message
            : "Įvyko klaida siunčiant užklausą",
        );
      } finally {
      ...
      <div className="mb-12 text-center relative">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Įkelk savo logotipą, uždėk jį ant rūbo ir gauk pasiūlymą per kelias
            minutes
          </p>
