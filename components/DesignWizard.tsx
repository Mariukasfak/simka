    ...
    <div className="mb-8">
      ...
      <div className="grid grid-cols-4 gap-2 mt-2">
        {steps.map((step, index) => (
          ...
          >
            {step === 'product' && (
              <span className={steps.indexOf(currentStep) >= index ? 'text-accent-600' : 'text-gray-400'}>
            ...
            {step === 'upload' && (
              <span className={hasUploadedImage ? 'text-accent-600' : 'text-gray-400'}>
                {hasUploadedImage ? '✓' : '•'}
              </span>
            )}
            
            {step === 'design' && (
              <span className={hasDesignedProduct ? 'text-accent-600' : 'text-gray-400'}>
                {hasDesignedProduct ? '✓' : '•'}
              </span>
            )}
