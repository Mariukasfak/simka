  ...
  const generatePreview = useCallback(
    debounce(async (forceGenerate = false) => {
      ...
      try {
        ...
        const originalLogo = originalCanvas.querySelector('.draggable-image') as HTMLElement | null;
        const previewLogo = previewContainer.querySelector('.draggable-image') as HTMLElement | null;
        ...
        const canvas = await html2canvas(previewContainer, {
          ...
          onclone: (clonedDoc, clonedElem) => {
            const clonedLogo = clonedElem.querySelector('.draggable-image') as HTMLElement | null;
