...
const orderFormSchema = z.object({
  name: z
    ...
    .regex(
      /^[a-zA-ZĄąČčĘęĖėĮįŠšŲųŪūŽž\s]+$/,
      "Vardas gali turėti tik raides ir tarpus",
    ),
  email: z
    .string()
  ...
  printAreas: z
    .array(z.string())
    .min(1, "Pasirinkite bent vieną spausdinimo vietą"),
  comments: z
    .string()
...
export default function EnhancedOrderForm({
  ...
  const [currentPreview, setCurrentPreview] =
    useState<PrintAreaPosition | null>(null);
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
        ...
        <p className="text-green-700 mb-6">
          Dėkojame už jūsų užsakymą. Netrukus susisieksime elektroniniu paštu
          dėl tolesnių detalių.
        </p>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          {selectedPrintAreas && selectedPrintAreas.length > 0 && (
            <p className="mt-2 text-xs text-gray-500">
              Pasirinktos spausdinimo vietos:{" "}
              {selectedPrintAreas
                .map((area) => printAreaLabels[area as PrintAreaPosition])
                .join(", ")}
            </p>
          )}
        </div>
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="flex justify-between">
              <span>
                Spausdinimas ({selectedPrintAreas?.length || 0} vietos):
              </span>
          ...
          <div className="mt-4 text-xs text-gray-500">
            * Pateikus užklausą, mes peržiūrėsime jūsų dizainą ir atsiųsime
            galutinę kainą el. paštu.
          </div>
        </div>
      </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-1">
              ...
              galėsite išsaugoti savo dizainus, peržiūrėti ankstesnius užsakymus
              ir greičiau atlikti pakartotinius užsakymus.
            </p>
          </div>
        </div>
      </div>
