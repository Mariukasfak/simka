        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link href="/" className="text-base text-gray-500 hover:text-brand-primary">
                  Pagrindinis
                </Link>
              </li>
              <li>
                <Link href="/products" className="text-base text-gray-500 hover:text-brand-primary">
                  Produktai
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <a href="mailto:info@siemka.lt" className="text-base text-gray-500 hover:text-brand-primary">
                  info@siemka.lt
                </a>
              </li>
              <li className="text-base text-gray-500">
