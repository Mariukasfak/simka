            ...
            {isLoading ? (
              ...
              <div className="flex space-x-4">
                ...
                <button
                  ...
                  className="text-gray-600 hover:text-gray-900 px-3 py-2 text-sm font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 rounded"
                >
                  Atsijungti
                </button>
              </div>
