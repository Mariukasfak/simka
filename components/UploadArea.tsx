...
// Wrapped UploadArea in React.memo. This isolates the heavy Drag & Drop and Animation
// logic from the frequent re-renders of the parent components (WizardContent/HomeContent).
// Parent component ensures that `onImageUpload` is memoized.
