  ...
  const renderProductStep = () => (
    <div className="space-y-6">
      ...
      <div className="flex justify-end">
        <button
          onClick={onNextStep}
          className="px-6 py-2 bg-accent-600 text-white rounded-lg hover:bg-accent-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2"
        >
          Toliau
        </button>
      </div>
    ...
    return (
      <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                {Object.entries(printAreas).map(([position, area]) => (
                  <button
                    ...
                    className={`p-3 rounded-lg text-center transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 ${
        ...
        <div className="flex justify-between">
          <button
            onClick={() => onNextStep()}
            className="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2"
          >
            Atgal
          </button>
          <button
            ...
            } rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2`}
          >
            Toliau į užsakymą
          </button>
        </div>
