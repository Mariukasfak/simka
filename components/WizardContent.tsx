  ...
  const renderProductStep = () => (
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow-sm">
        ...
        <p className="text-gray-600 mb-6">Pasirinkite rūbą, ant kurio bus dedama spauda</p>
  ...
  const renderUploadStep = () => (
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow-sm">
        ...
        <p className="text-gray-600 mb-6">Įkelkite logotipą ar paveikslėlį, kurį naudosite spaudai</p>
        ...
        <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-100">
          <h3 className="text-sm font-medium text-blue-800 mb-2">Patarimai geriausiems rezultatams:</h3>
    ...
    return (
      <div className="space-y-6">
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <p className="text-gray-600 mb-6">Pritaikykite dizainą ant rūbo - keiskite dydį ir poziciją</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-md font-medium mb-3">Pasirinkite spaudos vietą:</h3>
              <div className="grid grid-cols-2 gap-3 mb-4">
                {Object.entries(printAreas).map(([position, area]) => (
                  ...
                  >
                    <div className="text-sm font-medium">{(area as any).name}</div>
    ...
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-md font-medium mb-4">Jūsų sukurtas dizainas:</h3>
            <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  .map(([position, preview]) => (
                    <div key={position} className="relative">
                      ...
                      <div className="absolute top-1 right-1 bg-accent-100 text-xs text-accent-800 px-2 py-1 rounded-full">
                        {printAreas[position as PrintAreaPosition]?.name || position}
                      </div>
                    </div>
                  ))
                }
              ...
              <div className="mt-4 p-3 bg-gray-100 rounded-lg">
                <div className="text-sm font-medium">Pasirinktas produktas:</div>
