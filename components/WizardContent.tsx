    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex justify-between">
          <button
            onClick={() => onNextStep()}
            className="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-600 focus-visible:ring-offset-2"
          >
            Atgal
          </button>
          <button
