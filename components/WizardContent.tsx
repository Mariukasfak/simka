  ...
  const renderProductStep = () => (
    <div className="space-y-6">
      ...
      <div className="flex justify-end">
        <button
          onClick={onNextStep}
          className="px-6 py-2 bg-accent-600 text-white rounded-lg hover:bg-accent-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-accent-600"
        >
          Toliau
        </button>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between">
          ...
          <button
            ...
            className={`px-6 py-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-accent-600 ${
